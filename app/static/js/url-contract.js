(function() {
    ...
    var contractError = 'Mire browser URL contract is unavailable';
    ...
    var element = document.getElementById('mire-url-bootstrap');
    var bootstrap;
    try {
    ...
    Object.defineProperty(window, 'mireUrl', {
        configurable: false,
        writable: false,
        value: function(path) {
            if (!validInternalUrl(path)) throw new TypeError('Mire URL must be a safe root-relative internal URL');
