(function () {
    ...
    var element = document.getElementById('mire-settings-bootstrap');
    var bootstrap = MireBrowserContracts.parseSettingsBootstrapText(
    ...
    window.SECTION_TITLES = {
        ...
        support: T.support_title || 'Support Mire'
    };
