(function (root, factory) {
    ...
    if (root) Object.defineProperty(root, 'MireBrowserContracts', {
        configurable: false,
        writable: false,
        value: api
    });
    ...
    var BOOTSTRAP_ERROR = 'Invalid Mire bootstrap data';
    ...
    function computeServiceWorkerPolicy(hostname, search, scopeHref) {
        ...
        return {
            ...
            cacheNamespace: 'mire-' + encodeURIComponent(scope.pathname) + '-'
        };
    }
