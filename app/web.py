"""Flask web UI for Mire – DOCSIS channel monitoring."""
...
_THEME_COLLECTIONS = [
    {
        ...
        "description_fallback": "Mire's built-in identity themes",
        "ids": (
            "mire.theme_classic",
            "mire.theme_tribu",
            "mire.theme_ocean",
    ...
    },
    {
        ...
        "ids": (
            "mire.theme_one_dark",
            "mire.theme_dracula",
            "mire.theme_catppuccin_mocha",
            "mire.theme_tokyo_night",
            "mire.theme_nord",
            "mire.theme_synthwave",
            "mire.theme_gruvbox",
        ),
    },
    {
...
_AUTH_MARKER_CONTEXT = b"mire-admin-session-v1\0"
_AUTH_STATE_CONTEXT = b"mire-admin-auth-state-v1\0"
...
def bootstrap_auth_state(app, runtime):
    ...
    if app.extensions.get("mire") is not runtime:
        raise RuntimeError("Mire runtime is not attached to this application")
