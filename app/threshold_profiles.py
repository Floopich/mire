...
BUILTIN_THRESHOLD_PROFILES: tuple[dict[str, object], ...] = (
    {
        ...
        "thresholds": {
            "_meta": {
                ...
                "provenance": "Valeurs empiriques issues du module community.thresholds_voo v1.0.0 (auteur Floopich, MIT), non normatives. 1.1.0 ajoute les lignes ofdm de downstream_power et de snr, absentes du module, et precise l attribution de la ligne ofdm de snr.",
                "notes": "Seuils issus des retours de la communaute et des experts VOO. En pratique VOO, la voie retour n'a pas de borne basse significative ; seul un TX excessif pose probleme (normal sous 49 dBmV, 51 est le plafond sur 4 porteuses, les canaux tombent au-dela de 52). Puissances en dBmV, SNR/MER en dB. La plage bonne en voie descendante est elargie a +/-8 dBmV : la pratique VOO considere 8-10 dBmV comme non problematique. La ligne ofdm de downstream_power applique la meme regle VOO que les autres modulations. La ligne ofdm de snr est reprise du profil VFKD amont : ses bornes s appuient sur CableLabs DOCSIS 3.1 PHY CM-SP-PHYv3.1-I08, a l exception du seuil d avertissement de 25.5 dB que DOCSight indique avoir derive lui-meme. VOO ne publie pas de plancher de MER agrege : le MER agrege d un canal OFDM se mesure autrement que le SNR par porteuse, et sans ces lignes un canal OFDM serait juge sur le good_min de 40 dB du 4096QAM. Les tolerances VOO varient selon la zone : un segment ancien ou charge peut rester dans les tolerances de l operateur avec des valeurs que ce profil signale. Un canal montant durablement en 16QAM peut relever de la configuration du segment plutot que d une degradation : comparer l historique avant de conclure, un canal qui descend en 16QAM n a pas le meme sens qu un canal qui y est depuis l installation.",
            },
            "downstream_power": {
                "_default": "256QAM",
