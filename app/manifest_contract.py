#!/usr/bin/env python3
"""Pure-stdlib validation for Mire module manifests."""
    ...
    *,
    ...
    if "id" in raw and (
        ...
        errors.append(
            ...
            "dots/underscores, starting with a letter (e.g. 'mire.weather')"
        )
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Validate Mire module manifests using the core contract."
    )
