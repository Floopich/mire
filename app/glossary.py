...
_CATEGORY_DEFINITIONS: tuple[tuple[str, str, str], ...] = (
    ("docsis_terms", "DOCSIS terms", "Cable/DOCSIS protocol, signal, channel, and event terms that Mire explains."),
    ("mire_features", "Mire features", "Views, integrations, and evidence tools provided by Mire itself."),
)
...
_TERMS: tuple[GlossaryTerm, ...] = (
    _term(
        ...
        'DOCSIS carries internet service over coax cable. Mire reads modem, channel, and signal data from supported DOCSIS devices, so its evidence is about the cable access link rather than DSL.',
        'DOCSIS uses a mix of downstream and upstream channel families such as SC-QAM, OFDM, and OFDMA. Each family exposes different evidence, so Mire keeps channel type, direction, and support status separate.',
    ...
    _term(
        ...
        'Downstream channels carry downloads and other inbound traffic. Mire shows their lock state and signal quality separately from upstream channels.',
    ...
    _term(
        ...
        'Upstream channels carry uploads, requests, and modem ranging. Mire uses them as upload-side signal evidence.',
    ...
    _term(
        ...
        'DOCSIS modems often use multiple downstream and upstream channels at once. Mire groups visible channels so you can see what is bonded, locked, and healthy.',
    ...
    _term(
        ...
        'SC-QAM channels are traditional DOCSIS 3.0-style channels. Mire can usually show their power, SNR/MER, modulation, lock state, and health.',
    ...
    _term(
        ...
        'DOCSIS 3.1 uses OFDM for wide downstream receive channels. Mire labels it separately because OFDM evidence differs from classic SC-QAM rows.',
    ...
    _term(
        ...
        'OFDMA lets many modems share parts of a wide upstream block. Mire labels it separately from SC-QAM upstream channels.',
    ...
    _term(
        ...
        'Many modern modems show SC-QAM channels next to OFDM downstream or OFDMA upstream. Mire keeps those families separate in the evidence.',
    ...
    _term(
        ...
        'Higher QAM levels can carry more bits per symbol, but they need a cleaner signal. Mire shows modulation so drops or low-QAM states are visible.',
    ...
    _term(
        ...
        'In DOCSIS, an upstream drop to 4QAM/QPSK usually means the signal quality is severely degraded. Mire displays it as 4QAM to match other modulation labels.',
    ...
    _term(
        ...
        'Mire can show downstream receive power and upstream transmit power when the modem reports them. The two directions mean different things.',
    ...
    _term(
        ...
        'Correctable counters can rise even on a working line. Mire makes them useful by showing rate, timing, affected channels, and whether uncorrectables also rise.',
    ...
    _term(
        ...
        'Uncorrectables can mean lost channel-level data, especially when they grow during the observation window. Mire treats growth and timing as more important than one old total.',
    ...
    _term(
        ...
        'A T3 timeout usually means a missed ranging response; a T4 timeout is more severe and can lead to a resync. Mire uses them as timing evidence.',
    ...
    _term(
        ...
        'A CMTS or related access system manages DOCSIS modems, channels, scheduling, and service configuration. Mire usually sees only the modem side.',
    ...
    _term(
        ...
        'A vCMTS provides CMTS functions on server infrastructure instead of only dedicated hardware. Mire treats it as provider-side context.',
    ...
    _term(
        ...
        'In modern cable networks, Remote PHY can place PHY-layer functions in a remote node while the provider controls the service centrally. Mire normally sees modem-side effects only.',
        ...
        'Avoid guessing exact R-PHY placement from Mire alone. Use it as context for provider discussions while relying on modem-visible channels, events, and timing for evidence.',
    ),
    _term(
        ...
        'Return-path interference can make uploads and modem ranging unstable. Mire can show symptoms such as upstream power changes, lower modulation, T3/T4 events, or packet loss.',
        ...
        'Localize return-path issues by correlating upstream symptoms with event times and, when available, provider spectrum or plant evidence. Mire alone can show symptoms, not the exact ingress source.',
    ),
    _term(
        'node_segment',
        'docsis_terms',
    ...
    _term(
        ...
        ('Mire', 'DOCSIS', 'SNR', 'dBmV'),
        ('power_level', 'snr_mer', 'correctable_errors', 'uncorrectable_errors'),
        'Health status is Mire’s quick good/marginal/poor label for visible evidence.',
    ...
    _term(
        ...
        'Dashboard is Mire’s main overview of the current cable-connection evidence.',
    ...
    _term(
        ...
        'In-App Glossary explains DOCSIS and Mire words without leaving the app.',
        'The glossary links dashboard labels and help icons to plain-language explanations, aliases, and related terms.',
        'Glossary entries keep DOCSIS terms separate from Mire features so explanatory bridges do not become invented protocol facts.',
    ...
    _term(
        ...
        'A timeline can separate persistent impairment from a short transition, resync, maintenance window, or reporting gap. It depends on the snapshots Mire actually collected.',
    ...
    _term(
        ...
        'For DOCSIS 3.1 upstream Low-QAM, Mire treats ≤64QAM as the low-QAM boundary. OFDM/OFDMA profile data remains separate from DOCSIS 3.0 SC-QAM color semantics.',
    ...
    _term(
        ...
        'Incident Journal is where Mire keeps notes and evidence about connection problems.',
    ...
    _term(
        ...
        'Smart Capture collects relevant Mire evidence around a problem window.',
    ...
    _term(
        ...
        'LLM Export packages selected Mire evidence into support-friendly text.',
    ...
    _term(
        ...
        'Doctor Diagnostics guides checks for Mire setup and evidence collection.',
        'It helps separate configuration problems, modem-access problems, and actual line symptoms.',
        'Doctor checks are diagnostic scaffolding. They can confirm whether Mire can collect evidence, but they do not replace the evidence from modem data and incident windows.',
    ...
    _term(
        ...
        'PWA and Offline Mode make Mire installable and usable as an app shell.',
...
_GLOSSARY_WIKI_INDEX: dict[str, dict[str, tuple[str, ...]]] = {
    ...
    'shared_medium': {
        ...
        'ui_contexts': ('speedtest_correlation',),
    },
    'health_status': {
