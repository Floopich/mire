"""Theme registry helpers and built-in Mire theme definitions."""
...
from .module_download import is_trusted_url
...
BUILTIN_THEMES: tuple[dict[str, Any], ...] = ({'id': 'mire.theme_mire',
  'name': 'Mire',
  'description': 'Corail sur ardoise — les couleurs de Mire',
  'version': '1.0.0',
  'author': 'floopich',
  ...
  'theme_data': {'meta': {'family': 'dark-first'},
                 'dark': {'--bg': '#0f1215',
                          '--surface': '#141820',
                          '--card': '#181d26',
                          '--card-border': 'rgba(232, 129, 127, 0.14)',
                          '--text': '#e8eaed',
                          ...
                          '--accent': '#e8817f',
                          '--accent-hover': '#f0a09e',
                          '--accent-muted': 'rgba(232, 129, 127, 0.12)',
                          '--info': '#7dd3fc',
                          '--input-border': 'rgba(232, 129, 127, 0.2)',
                          '--overlay': 'rgba(8, 10, 13, 0.8)',
                          '--hover-bg': 'rgba(232, 129, 127, 0.06)',
                          '--void': '#0a0d10',
                          '--void-deep': '#06080a',
                          '--elevated': '#1e242e',
                          '--hover': '#252c37',
                          '--amethyst': '#e8817f',
                          '--amethyst-light': '#f0a09e',
                          '--sapphire': '#7dd3fc',
                          '--glass-bg': 'rgba(20, 24, 32, 0.9)',
                          '--glass-border': 'rgba(232, 129, 127, 0.1)',
                          '--font-sans': 'inherit',
                          '--font-mono': 'inherit'},
                 'light': {'--bg': '#faf8f8',
                           '--surface': '#ffffff',
                           ...
                           '--accent': '#c95f5d',
                           '--accent-hover': '#a94240',
                           '--accent-muted': 'rgba(201, 95, 93, 0.1)',
                           '--info': '#0369a1',
                           '--input-border': '#ddd0d0',
                           '--overlay': 'rgba(0, 0, 0, 0.4)',
                           '--hover-bg': 'rgba(201, 95, 93, 0.05)',
                           '--void': '#faf8f8',
                           '--void-deep': '#f2eded',
                           '--elevated': '#f5f0f0',
                           '--hover': '#ebe3e3',
                           '--amethyst': '#c95f5d',
                           '--amethyst-light': '#d97b79',
                           '--sapphire': '#0369a1',
                           '--glass-bg': 'rgba(255, 255, 255, 0.85)',
                           '--glass-border': 'rgba(201, 95, 93, 0.08)',
                           '--font-sans': 'inherit',
                           '--font-mono': 'inherit'}}},
 {'id': 'mire.theme_amber_terminal',
  'name': 'Amber Terminal',
  ...
  'theme_data': {'meta': {'family': 'dark-first'},
                 ...
                 'light': {'--bg': '#fff8e8',
                           ...
                           '--font-sans': "'Courier New', 'Consolas', monospace",
                           '--font-mono': "'Courier New', 'Consolas', monospace"}}},
 {'id': 'mire.theme_catppuccin_mocha',
 ...
 {'id': 'mire.theme_classic',
  'name': 'Classic',
  'description': 'The original Mire charcoal and purple design',
  'version': '1.0.0',
  'author': 'itsDNNS',
  'minAppVersion': '2026.2',
  'theme_data': {'meta': {'family': 'dark-first'},
