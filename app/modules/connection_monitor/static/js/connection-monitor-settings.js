(function () {
    ...
    var bootstrapElement = document.getElementById('mire-connection-monitor-settings-bootstrap');
    var i18n = MireBrowserContracts.parseConnectionMonitorBootstrapText(
    ...
    function renderTarget(target) {
        ...
        removeBtn.addEventListener('click', function () {
            ...
            fetch(mireUrl('/api/connection-monitor/targets/' + tid), {method: 'DELETE'})
                .then(function (res) {
