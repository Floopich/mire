"""Deterministic Flask application construction for Mire."""
...
def create_app(
    *,
    ...
    """Create one fully isolated Mire application in a fixed order.
    ...
    planning_app.extensions["mire_registration_deferred"] = True
    planning_app.extensions["mire_registration_base_plan"] = core_plan
    ...
    app.extensions["mire_module_loader"] = loader
    app.extensions["mire_registration_manifest"] = manifest
    app.extensions["mire_registration_fingerprint"] = fingerprint
