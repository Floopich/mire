"""Immutable planning and atomic application of Mire registrations."""
...
def register_plan(app: Flask, plan: RegistrationPlan) -> None:
    ...
    applied = app.extensions.get("mire_applied_registration_plans", ())
    ...
    previous = app.extensions.get("mire_registration_plan", RegistrationPlan())
    ...
    app.extensions["mire_registration_plan"] = complete
    app.extensions["mire_applied_registration_plans"] = (*applied, plan)
...
def canonical_manifest(app: Flask, module_loader=None) -> dict[str, object]:
    ...
    plan = app.extensions.get("mire_registration_plan")
    sources = {}
