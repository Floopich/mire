...
| Comparison page | Planned | A deeper public guide comparing Mire with uptime, speedtest and latency tools. |

## Intentionally out of scope

| Area | Reason |
|---|---|
| Legal guarantee | Mire documents evidence but cannot guarantee ISP or regulator outcomes. |
| Managed cloud monitoring | The project is local-first and self-hosted. |
| Public status-page replacement | Mire can help diagnose connection history, but uptime status pages are a different product class. |
