...
- Mire can put signal health, speed, packet loss, events, notes, and reporting into one timeline.
...
- replies where someone asks how Mire differs from a speedtest dashboard
...
- Mire can turn collected measurements into a PDF report.
...
### Your ISP says everything is fine. Mire shows the timeline.
...
- comparing Mire with speedtest history tools
...
4. **Privacy/local-first architecture**
   - Show modem/router, Mire container, SQLite storage, optional Home Assistant/MQTT, optional exports.
