...
def test_keyed_sha256_digest_is_compatible_with_existing_auth_state_format():
    ...
    # Contexte propre a Mire (b"mire-admin-auth-state-v1\0") : empreinte differente
    # de l amont, ce qui invalide toute session heritee d une instance DOCSight.
    assert digest == "293e0e7e41dcced312f4d6e6fe7b0adb07cb3e7748f5b9b4482493cac31515e6"
