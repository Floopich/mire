...
class TestStaticAndTemplates:
    ...
    def test_module_static_endpoint_and_url_helper_share_prefix_aware_contract(self):
        ...
        with tempfile.TemporaryDirectory(ignore_cleanup_errors=True) as d:
            ...
            with app.test_request_context(
                "/", environ_overrides={"SCRIPT_NAME": "/mire"}
            ):
                assert module_loader.module_static_url(
                    "test.mod", "test.js", v="1.2.3"
                ) == "/mire/modules/test.mod/static/test.js?v=1.2.3"
...
class TestModuleAssetDetection:
    ...
    def test_colliding_legacy_static_endpoint_ids_remain_isolated(self, tmp_path):
        ...
        with app.test_request_context(
            ...
            ) == "/mire/modules/foo.bar/static/main.js?v=1.2.3"
            assert module_loader.module_static_url(
                "foo_bar", "main.js", v="1.2.3"
            ) == "/mire/modules/foo_bar/static/main.js?v=1.2.3"
    ...
    def test_conventional_static_assets_register_prefix_aware_endpoint(self, tmp_path):
        ...
        with app.test_request_context(
            ...
            assert module_loader.module_static_url(
                mod.id, "main.js", v="1.2.3"
            ) == "/mire/modules/community.conventional/static/main.js?v=1.2.3"
    ...
    def test_has_css_when_style_exists(self, tmp_path):
        ...
        mod_dir.mkdir()
        (mod_dir / "manifest.json").write_text(json.dumps({
            "id": "mire.css_test", "name": "CSS Test", "description": "d",
    ...
    def test_has_js_when_main_exists(self, tmp_path):
        ...
        mod_dir.mkdir()
        (mod_dir / "manifest.json").write_text(json.dumps({
            "id": "mire.js_test", "name": "JS Test", "description": "d",
            "version": "1.0.0", "author": "a", "minAppVersion": "2026.2",
            "type": "integration", "contributes": {"static": "static/"},
        }))
        static = mod_dir / "static"
    ...
    def test_no_assets_when_no_static(self, tmp_path):
        ...
        mod_dir.mkdir()
        (mod_dir / "manifest.json").write_text(json.dumps({
            "id": "mire.no_assets", "name": "No Assets", "description": "d",
            "version": "1.0.0", "author": "a", "minAppVersion": "2026.2",
