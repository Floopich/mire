...
def test_publish_data_preserves_raw_error_values_and_missing_channel_counter():
    ...
    assert published["mire/ds_correctable_errors"] == "None"
    assert published["mire/ds_uncorrectable_errors"] == "1000"
    assert published["mire/ds_uncorr_pct"] == "None"
    channel = json.loads(published["mire/channel/ds_ch100"])
