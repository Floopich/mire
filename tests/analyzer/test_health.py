    ...
    def test_threshold_classifications(self):
        cases = [
            ...
            },
            {
                ...
                "data": _make_data(
                    ds30=[_make_ds30(1, power=2.0, mse="-34")],
                    us30=[_make_us30(1, power=42.0)],
                ),
            },
        ]
    ...
    def test_threshold_classifications(self):
        cases = [
            ...
            },
            {
                ...
                "data": _make_data(
                    ds30=[_make_ds30(1, power=2.0, mse="-31.0")],
                    us30=[_make_us30(1, power=42.0)],
                ),
            },
        ]
        ...
        cases = [
            {
                ...
                "data": _make_data(
                    ds30=[_make_ds30(1, power=16.0, mse="-35")],
                    us30=[_make_us30(1, power=44.0)],
                ),
            },
            {
