...
class TestOFDMThresholds:
    ...
    @pytest.mark.parametrize(
        ("mse", "expected_health"),
        [
            # Profil VOO 256QAM : good_min 35.0, warning_min 33.0, critical_min 30.0.
    ...
    def test_sc_qam_snr_boundaries_follow_voo_profile(self, mse, expected_health):
        data = _make_data(
...
class TestSignalFamilySummaries:
    ...
    def test_docsis31_upstream_qam_modulation_without_type_stays_ofdma(self):
        ...
        # 50.5 dBmV : au-dessus du normal VOO (49) mais sous le plafond de 51.
        assert result["us_channels"][-1]["power_health"] == "tolerated"
    ...
    def test_downstream_ofdm_family_counts_and_driver_explain_power_outlier(self):
        data = _make_data(
            ds31=[
                _make_ds31(193, power=7.9, mer="42.0"),
                {
                    "channelID": 194,
                    "frequency": "167 MHz",
                    "powerLevel": "-15.1",
    ...
    @pytest.mark.parametrize(
        ...
        [
            # Profil VOO ofdm : good +/-8, warning +/-10, critical +/-15 dBmV.
            # Valeurs empiriques (forum.voo.be), non normatives.
            (-15.1, "critical"),
            (-15.0, "warning"),
            (-10.1, "warning"),
    ...
    def test_ofdm_power_boundaries_follow_voo_profile(self, power, expected_health):
        data = _make_data(
    ...
    def test_reported_ofdm_fixture_is_good_for_mer_and_power(self):
        data = _make_data(
            ds31=[
                ...
                _make_ds31(194, power=-7.9, mer="36.0"),
            ],
            us30=[_make_us30(1, power=42.0)],
        )
