...
**Technicolor CGA4233** en firmware VOO ; d'autres suivront. Mire fonctionne que le
modem soit en bridge ou en routeur, selon votre installation.

L'adresse dépend de l'opérateur : `192.168.0.1` chez VOO, Hey et Orange,
`192.168.1.1` chez Proximus, Scarlet et Viking Mobile. En bridge, la page de
diagnostic DOCSIS répond aussi sur `192.168.100.1`. L'assistant teste ces adresses
tout seul ; l'adresse et les identifiants restent à vérifier sur place plutôt qu'à
supposer.
